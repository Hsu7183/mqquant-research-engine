...
def backtest_m1_to_latest(m1_path: str, strategy_name: str) -> dict:
    params = SimpleM1StrategyParams(strategy_name=strategy_name)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = backtest_m1_to_latest(args.m1_path, args.strategy_name)
