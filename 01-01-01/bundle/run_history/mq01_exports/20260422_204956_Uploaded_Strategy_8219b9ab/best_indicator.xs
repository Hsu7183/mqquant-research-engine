...
input:
    DonLen(298, "1.Don長度"),
    ATRLen(8, "2.ATR長度"),
    EMAWarmBars(9, "3.EMA定錨回推日數"),
    EntryBufferPts(84, "4.NH/NL突破緩衝點數"),
    DonBufferPts(111, "5.Don突破緩衝點數"),
    MinATRD(188, "6.最小日ATR濾網"),
    ATRStopK(0.51, "7.ATR停損倍數"),
    ATRTakeProfitK(0.59, "8.ATR停利倍率"),
    MaxEntriesPerDay(1, "9.單日最多進場次數"),
    TimeStopBars(57, "10.時間停損Bars"),
    MinRunPctAnchor(0.27, "11.時間停損最小發動(定錨%)"),
    TrailStartPctAnchor(0.47, "12.回吐停利啟動(定錨%)"),
    TrailGivePctAnchor(0.8, "13.回吐停利允許回吐(定錨%)"),
