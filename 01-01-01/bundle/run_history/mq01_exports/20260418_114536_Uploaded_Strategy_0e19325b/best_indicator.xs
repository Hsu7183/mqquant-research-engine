...
input:
    ...
    EntryBufferPts(80, "4.NH/NL突破緩衝點數"),
    DonBufferPts(115, "5.Don突破緩衝點數"),
    MinATRD(121, "6.最小日ATR濾網"),
    ATRStopK(0.3, "7.ATR停損倍數"),
    ATRTakeProfitK(1.08, "8.ATR停利倍率"),
    MaxEntriesPerDay(2, "9.單日最多進場次數"),
    TimeStopBars(69, "10.時間停損Bars"),
    MinRunPctAnchor(0.36, "11.時間停損最小發動(定錨%)"),
    TrailStartPctAnchor(0.67, "12.回吐停利啟動(定錨%)"),
    TrailGivePctAnchor(0.04, "13.回吐停利允許回吐(定錨%)"),
    UseAnchorExit(1, "14.是否啟用08:48定錨失敗出場"),
    AnchorBackPct(0.39, "15.定錨失敗出場(定錨%)"),
