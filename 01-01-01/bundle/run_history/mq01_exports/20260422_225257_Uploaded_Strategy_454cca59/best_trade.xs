...
input:
    DonLen(274, "1.Don長度"),
    ATRLen(8, "2.ATR長度"),
    EMAWarmBars(2, "3.EMA定錨回推日數"),
    EntryBufferPts(111, "4.NH/NL突破緩衝點數"),
    DonBufferPts(74, "5.Don突破緩衝點數"),
    MinATRD(188, "6.最小日ATR濾網"),
    ATRStopK(0.51, "7.ATR停損倍數"),
    ATRTakeProfitK(1.16, "8.ATR停利倍率"),
    MaxEntriesPerDay(2, "9.單日最多進場次數"),
    TimeStopBars(73, "10.時間停損Bars"),
    MinRunPctAnchor(0.74, "11.時間停損最小發動(定錨%)"),
    TrailStartPctAnchor(0.39, "12.回吐停利啟動(定錨%)"),
    TrailGivePctAnchor(0.79, "13.回吐停利允許回吐(定錨%)"),
    UseAnchorExit(0, "14.是否啟用08:48定錨失敗出場"),
    AnchorBackPct(0.01, "15.定錨失敗出場(定錨%)"),
