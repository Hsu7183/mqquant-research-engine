...
input:
    DonLen(274, "1.Don長度"),
    ATRLen(2, "2.ATR長度"),
    EMAWarmBars(7, "3.EMA定錨回推日數"),
    EntryBufferPts(84, "4.NH/NL突破緩衝點數"),
    DonBufferPts(114, "5.Don突破緩衝點數"),
    MinATRD(178, "6.最小日ATR濾網"),
    ATRStopK(0.57, "7.ATR停損倍數"),
    ATRTakeProfitK(0.69, "8.ATR停利倍率"),
    MaxEntriesPerDay(10, "9.單日最多進場次數"),
    TimeStopBars(103, "10.時間停損Bars"),
    MinRunPctAnchor(0.12, "11.時間停損最小發動(定錨%)"),
