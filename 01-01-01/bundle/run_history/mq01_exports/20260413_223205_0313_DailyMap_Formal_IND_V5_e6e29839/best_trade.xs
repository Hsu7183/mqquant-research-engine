...
input:
    ...
    EntryBufferPts       (135,     "4.NH/NL突破緩衝點數"),
    DonBufferPts         (122,     "5.Don突破緩衝點數"),
    MinATRD              (99,      "6.最小日ATR濾網"),
    ATRStopK             (0.62,   "7.ATR停損倍數"),
    ATRTakeProfitK       (1.08,   "8.ATR停利倍率"),

    MaxEntriesPerDay     (5,      "9.單日最多進場次數"),
    TimeStopBars         (57,     "10.時間停損Bars"),

    MinRunPctAnchor      (0.15,   "11.時間停損最小發動(定錨%)"),
    TrailStartPctAnchor  (0.9,   "12.回吐停利啟動(定錨%)"),
    TrailGivePctAnchor   (0.07,   "13.回吐停利允許回吐(定錨%)"),

    UseAnchorExit        (1,      "14.是否啟用08:48定錨失敗出場(1=是,0=否)"),
    AnchorBackPct        (0.9,   "15.定錨失敗出場(定錨%)");
