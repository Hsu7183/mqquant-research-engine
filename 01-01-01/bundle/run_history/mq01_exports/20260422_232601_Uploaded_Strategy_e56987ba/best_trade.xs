...
input:
    ...
    DonBufferPts(17, "5.Don突破緩衝點數"),
    MinATRD(196, "6.最小日ATR濾網"),
    ATRStopK(0.51, "7.ATR停損倍數"),
    ATRTakeProfitK(1.21, "8.ATR停利倍率"),
    MaxEntriesPerDay(2, "9.單日最多進場次數"),
    TimeStopBars(73, "10.時間停損Bars"),
    MinRunPctAnchor(0.74, "11.時間停損最小發動(定錨%)"),
    TrailStartPctAnchor(0.56, "12.回吐停利啟動(定錨%)"),
    TrailGivePctAnchor(0.78, "13.回吐停利允許回吐(定錨%)"),
